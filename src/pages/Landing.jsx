...
function FAQItem({ q, a }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 15, fontWeight: 500, color: "#EFF6FF" }}>{q}</span>
        <span style={{ color: "#4B5563", fontSize: 20, lineHeight: 1, flexShrink: 0, transition: "transform 0.2s", transform: open ? "rotate(45deg)" : "none" }}>+</span>
      </button>
      {open && (
        <p style={{ fontSize: 14, color: "#9CA3AF", lineHeight: 1.75, paddingBottom: 4 }}>{a}</p>
      )}
    </div>
  );
}
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        ...
        >
          ...
          <br />
          <span style={{ color: "#3B82F6" }}>We make them reconsider.</span>
        </h1>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{
              ...
              border: "1px solid #1a2640", borderRadius: 12, padding: "16px 28px",
        ...
        <p style={{ fontSize: 13, color: "#374151", marginTop: 18 }}>
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "80px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <h2 style={{ fontSize: "clamp(24px, 3vw, 32px)", fontWeight: 700, letterSpacing: -0.5, color: "#EFF6FF", marginBottom: 8 }}>
            Built to win, built to protect you
          </h2>
          <p style={{ fontSize: 15, color: "#6B7280" }}>Every letter is reviewed for accuracy before it goes out.</p>
        </div>
      ...
      <section style={{ background: "#070c18", borderTop: "1px solid #0f1827" }}>
        <div style={{ maxWidth: 660, margin: "0 auto", padding: "80px 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ fontSize: "clamp(24px, 3vw, 32px)", fontWeight: 700, letterSpacing: -0.5, color: "#EFF6FF" }}>
              Common questions
            </h2>
          </div>
          <div>
      ...
      <section style={{ maxWidth: 700, margin: "0 auto", padding: "96px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 13, color: "#374151", marginTop: 16 }}>Free · No account · Not legal advice</p>
      </section>
      ...
      >
        ...
        <div style={{ fontSize: 12, color: "#1e2d42" }}>
